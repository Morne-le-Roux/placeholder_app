...
// import 'paautomatic_keep_alive.dart';
// import 'basic.dart';
// import 'debug.dart';
...
/// Signature used by [ClippedDismissible] to indicate that it has been dismissed in
/// the given `direction`.
///
/// Used by [ClippedDismissible.onDismissed].
typedef DismissDirectionCallback = void Function(DismissDirection direction);

/// Signature used by [ClippedDismissible] to give the application an opportunity to
/// confirm or veto a dismiss gesture.
///
/// Used by [ClippedDismissible.confirmDismiss].
typedef ConfirmDismissCallback = Future<bool?> Function(
    DismissDirection direction);

/// Signature used by [ClippedDismissible] to indicate that the dismissible has been dragged.
///
/// Used by [ClippedDismissible.onUpdate].
typedef DismissUpdateCallback = void Function(DismissUpdateDetails details);

/// The direction in which a [ClippedDismissible] can be dismissed.
enum DismissDirection {
  /// The [ClippedDismissible] can be dismissed by dragging either up or down.
  vertical,

  /// The [ClippedDismissible] can be dismissed by dragging either left or right.
  horizontal,

  /// The [ClippedDismissible] can be dismissed by dragging in the reverse of the
  /// reading direction (e.g., from right to left in left-to-right languages).
  endToStart,

  /// The [ClippedDismissible] can be dismissed by dragging in the reading direction
  /// (e.g., from left to right in left-to-right languages).
  startToEnd,

  /// The [ClippedDismissible] can be dismissed by dragging up only.
  up,

  /// The [ClippedDismissible] can be dismissed by dragging down only.
  down,

  /// The [ClippedDismissible] cannot be dismissed by dragging.
  none
}
...
///
/// {@tool dartpad}
/// This sample shows how you can use the [ClippedDismissible] widget to
...
class ClippedDismissible extends StatefulWidget {
  /// Creates a widget that can be dismissed.
  ///
  /// The [key] argument is required because [ClippedDismissible]s are commonly used in
  ...
  @override
  State<ClippedDismissible> createState() => _ClippedDismissibleState();
}
...
/// See also:
///
///   * [ClippedDismissible.onUpdate], which receives this information.
class DismissUpdateDetails {
  ...
  /// that the [ClippedDismissible] is dragged across the threshold.
...
class _ClippedDismissibleState extends State<ClippedDismissible>
